...
//             const plateId = isEditing ? currentPlateId : Date.now().toString();
//             const existingPlate = licensePlates.find(p => p.id === plateId);

//             await set(ref(database, `licensePlates/${plateId}`), {
//                 plateNumber: plateNumber.trim().toUpperCase(),
//                 ownerName: ownerName.trim(),
//                 createdAt: isEditing ? (existingPlate?.createdAt || Date.now()) : Date.now(),
//                 updatedAt: Date.now(),
//                 ownerUid: auth.currentUser.uid, // Add ownership tracking
//             });
